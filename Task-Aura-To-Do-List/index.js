...
document.addEventListener("DOMContentLoaded", function() {
    ...
    //logic to add task, can be used for voice commands only,
...
function clearAllTasks() {
    ...
    if (taskList.children.length > 0) {
        ...
        // If there are no tasks, choose to show a message or take alternative action
...
document.addEventListener("DOMContentLoaded", function() {
    const headerText = "Divyanshu's To-Do List Application";
